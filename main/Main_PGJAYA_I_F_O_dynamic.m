...
save('../data/PGJAYA_FO_dynamic') % save results of the fractional order model

%save('../data/PGJAYA_IO_dynamic') % save results of the integer order model
% % %
...
load('../data/PGJAYA_FO_dynamic.mat')
[Mm  II]=min(Best_score);
Mm_std=std(Best_score);
x=Best_pos(II,:);
